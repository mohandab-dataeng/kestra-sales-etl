...
# ---------------------------------------------------------
ca_par_produit = pd.read_csv("./export/ca_pro_s3.csv")
ca_total = pd.read_csv("./export/ca_tot_s3.csv")
vins_premium = pd.read_csv("./export/vins_premiums.csv")
vins_ordinaires = pd.read_csv("./export/vins_ordinaires.csv")
